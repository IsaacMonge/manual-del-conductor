                    ...
                    <div className="body">
                        ...
                        <div className="quiz-data">
                            <div className="left">
                                ...
                                <div className="comments">{this.state.quiz.comments.length} Comentarios</div>
                            </div>
                            <div className="right">
                                <div className="likes">{this.state.quiz.likes} Likes</div>
                                <div className="others">{this.state.quiz.scores.length} Personas que han tomado este quiz</div>
                            </div>
                        </div>

                        <div className="score">
                           Puntación: {this.getScore()}
                        </div>
