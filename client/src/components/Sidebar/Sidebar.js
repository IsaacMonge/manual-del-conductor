        ...
        if (store.getState().user) {
            return (
                <div className="sidebar-wrapper">
                    <div className="header">Nombre de la App</div>
                    ...
                    <div className="links">
                        ...
                        <NavLink to="/account"><div className="link">Cuenta</div></NavLink>
                        <NavLink to="/my-quizzes"><div className="link">Mis Quizzes</div></NavLink>
                        <NavLink to="/create-quiz"><div className="link">Crear Quiz</div></NavLink>
                        <NavLink to="/community-quizzes"><div className="link">Sobre Nosotros</div></NavLink>
                    </div>
                </div>
            )
        } else {
