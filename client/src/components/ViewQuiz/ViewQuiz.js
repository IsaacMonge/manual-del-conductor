    ...
    render() {
        return !this.state.isLoading ? (
            <div className="view-quiz">
                {!this.state.isAuthenticated ? <div className="not-auth">Debes estar registrado para tomar el quiz</div> : 
                <div className="content">
                    ...
                    <div className="body">
                        ...
                        <div className="right">
                            <div className="questions-num">{this.state.quiz.questions.length} Preguntas</div>
                            <div className={this.state.quiz.createdBy === localStorage.getItem('_ID') ? 'questions-wrapper' : 'questions-wrapper no-scroll'}>
                                ...
                                {this.state.quiz.createdBy !== localStorage.getItem('_ID') ? <div className="hidden"><div>Debes ser un creador para ver el quiz</div></div> : ''}
                            </div>
                        </div>
                    </div>
                    <div className="footer">
                        <div className="buttons-wrapper">
                            ...
                            <button onClick={this.startQuiz}>Tomar Quiz</button>
                        </div>
                    </div>
                </div>
                }
