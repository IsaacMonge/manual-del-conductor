    ...
    render() {
        return (
            <div className="community-quizzes-wrapper">
                ...
                <div className="body">
                    <div className="header-top">Sobre nosotros</div>
                    <div className="quizzes-wrapper">
                        {this.state.quizzes.map((quiz, idx) => (
                            <div key={idx} className="quiz-card card">
                                ...
                                <div className="questions">{quiz.questions.length} Preguntas</div>
                                <div className="take-quiz btn" onClick={() => this.takeQuiz(quiz._id)}>Tomar Quiz</div>
