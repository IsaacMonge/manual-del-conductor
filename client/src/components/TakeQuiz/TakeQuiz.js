              ...
              <>
                    <div id="modal-wrapper-quiz" className="modal-wrapper-quiz">
                        <div className="content">
                            <div className="header">¿Estas seguro que quieres enviar estas respuestas?</div>
                            <div className="buttons-wrapper">
                                <button onClick={this.hideModal}>Cancelar</button>
                                <button onClick={this.finishQuiz}>Enviar</button>
                            </div>
                        </div>
                    </div>
                        ...
                        {this.state.authorized ?
                            ...
                            <div className="content">
                                ...
                                <div className="footer">
                                    <div className="buttons-wrapper">
                                        <button onClick={this.prevQuestion}>Anterior</button>
                                        {this.state.activeQuestionIdx + 1 < this.state.quiz.questions.length ? <button onClick={this.nextQuestion}>Siguiente</button> : <button onClick={this.showModal}>Enviar Quiz</button>}
                                    </div>
                                </div>
                            </div>
